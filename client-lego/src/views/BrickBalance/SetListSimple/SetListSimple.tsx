...
class SetListSimple extends React.Component<SetListSimpleProps & SetListSimpleDispatchProps> {
        ...
        return <>
            ...
            <div className="table-responsive">
                <table className="table table-striped table-sm">
                    ...
                    <tbody>
                        {
                            sets.map(({ set_number, name, description }: any, index: any) => {
                                return (
...
export default connect(mapStateToProps, mapDispatchToProps)(SetListSimple);