...
SELECT img_pathname,
	...
	s10195.quantity as set_10195_q,
    	s75151.quantity as set_75151_q,

	(
		ifnull(s7675.quantity, 0) + ifnull(s7676.quantity, 0) + ifnull(s10195.quantity, 0) + ifnull(s75151.quantity, 0) 
	) as total_q,
	s7675.lego_set_id,
	s7676.lego_set_id,
	s10195.lego_set_id,
