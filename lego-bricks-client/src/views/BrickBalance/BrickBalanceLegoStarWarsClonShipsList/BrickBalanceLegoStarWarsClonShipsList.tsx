    ...
    render() {
        ...
        return <>
            <div>  <h2>Lista klocków</h2>
                <ul className="nav">
                    <li className="nav-item cursor-pointer" onClick={this.goToSet.bind(this, '7675')}><span className="nav-link" > AT-TE Walker</span></li>
                    <li className="nav-item cursor-pointer" onClick={this.goToSet.bind(this, '7676')}><span className="nav-link" > Republic Attack Gunship</span></li>
                    <li className="nav-item cursor-pointer" onClick={this.goToSet.bind(this, '10195')}><span className="nav-link" >Republic Dropship with AT-OT</span></li>
                </ul>
            </div>
