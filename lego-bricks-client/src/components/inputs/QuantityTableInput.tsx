...
const totalSchema = Yup.object().shape({
  quantity_total_value: Yup.number().required("Required"),
});

const QuantityTableInput: React.FC<QuantityTableInputProps> = ({
  element_id,
  lego_set_id,
  updateTotalValue,
}) => {
          ...
          <div className="input-group">
            <Field
              ...
              className={classNames("form-control", {
                "is-invalid": errors.quantity_total_value,
              })}
              placeholder="ile"
              type="text"
            />
